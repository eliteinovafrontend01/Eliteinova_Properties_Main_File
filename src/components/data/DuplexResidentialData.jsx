...
export const DuplexResidentialData = [
  // BUY - Luxury Villa (Posted by OWNER)
  {
    ...
    status: "NEW",
    price: "₹6.8 Crores",
    sqftPrice: "₹14,000 per sqft",
    totalSqft: "4,850 sqft Carpet Area",
    builtUp: "5,200 sqft (Built Up area)",
    location: "Ashok Nagar, Chennai-600091, Tamil Nadu",
    highlights: "Fully Furnished | 4 BHK | Ready to Move | Private Terrace",
  ...
  // SELL - Premium Villa (Posted by SELLER)
  {
    ...
    status: "RE-SALE",
    price: "₹3.5 Crores",
    sqftPrice: "₹11,000 per sqft",
    totalSqft: "3,180 sqft Carpet Area",
    builtUp: "3,500 sqft (Built Up area)",
    location: "Ekkaduthangal, Chennai-600032, Tamil Nadu",
    highlights: "Unfurnished | 3 BHK | Home Theatre | Gym Area",
    postedBy: "Manickam",
    postedAs: "Seller",
    logo: "",
  ...
  // LEASE - Corporate Villa (Posted by LESSOR/OWNER)
  {
    ...
    totalSqft: "2,200 sqft Carpet Area",
    builtUp: "2,400 sqft (Built Up area)",
    location: "Velachery, Chennai-600042, Tamil Nadu",
    highlights: "Unfurnished | 3 BHK | Near IT Park | Separate Entry",
    postedBy: "Suresh",
    postedAs: "Lessor",
    logo: "",
  ...
  // BUY - Premium Resale Villa (Posted by REAL ESTATE AGENT)
  {
    ...
    status: "RE-SALE",
    price: "₹4.8 Crores",
    sqftPrice: "₹13,500 per sqft",
    totalSqft: "3,560 sqft Carpet Area",
    builtUp: "3,800 sqft (Built Up area)",
    location: "Adyar, Chennai-600020, Tamil Nadu",
    highlights: "Semi-Furnished | 4 BHK | Private Garden | Skylight",
  ...
  // RENT - Budget Villa (Posted by OWNER)
  {
    ...
    highlights: "Semi-Furnished | 2 BHK | Close to Metro | Modern Design",
    postedBy: "Rajesh V",
    postedAs: "Owner",
    logo: "",
  ...
  // SELL - Affordable Villa (Posted by SELLER)
  {
    ...
    totalSqft: "2,120 sqft Carpet Area",
    builtUp: "2,300 sqft (Built Up area)",
    location: "Madipakkam, Chennai-600091, Tamil Nadu",
    highlights: "Semi-Furnished | 3 BHK | Affordable | Vaastu Compliant",
    postedBy: "Deepak",
    postedAs: "Seller",
    logo: "",
  ...
  // LEASE - Compact Villa (Posted by OWNER)
  {
    ...
    totalSqft: "1,650 sqft Carpet Area",
    builtUp: "1,800 sqft (Built Up area)",
  ...
  // BUY - Modern Villa (Posted by BUILDER/DEVELOPER)
  {
    ...
    totalSqft: "2,760 sqft Carpet Area",
    builtUp: "3,000 sqft (Built Up area)",
    location: "OMR, Thoraipakkam, Chennai-600097, Tamil Nadu",
    highlights: "Unfurnished | 3 BHK | Rooftop Access | Smart Home Features",
    postedBy: "Siva Kumar",
    postedAs: "Builder",
    logo: "",
  ...
  // RENT - Heritage Style Villa (Posted by AGENT)
  {
    ...
    status: "RE-SALE",
    price: "₹95,000/month",
    sqftPrice: "₹52 per sqft",
    totalSqft: "1,830 sqft Carpet Area",
    builtUp: "2,000 sqft (Built Up area)",
    location: "Mylapore, Chennai-600004, Tamil Nadu",
    highlights: "Semi-Furnished | 3 BHK | Traditional Style | Wooden Flooring",
