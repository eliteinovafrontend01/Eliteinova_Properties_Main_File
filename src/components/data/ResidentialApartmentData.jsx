// Import all images from assets (update these paths to your actual villa images)
...
export const ResidentialApartmentData= [
  // BUY - Luxury Villa (Posted by OWNER)
  {
    ...
    status: "NEW",
    price: "₹4.5 Crores",
    sqftPrice: "₹15,000 per sqft",
    totalSqft: "3,000 sqft Carpet Area",
    builtUp: "3,200 sqft (Built Up area)",
    location: "Ashok Nagar, Chennai-600091, Tamil Nadu",
    highlights: "Fully Furnished | 4 BHK | Ready to Move | Luxury Villa ",
  ...
  // RENT - Sea View Villa (Posted by OWNER)
  {
    ...
    status: "RE-SALE",
    price: "₹85,000/month",
    sqftPrice: "₹55 per sqft",
    totalSqft: "1,550 sqft Carpet Area",
    builtUp: "1,700 sqft (Built Up area)",
    location: "Besant Nagar, Chennai-600090, Tamil Nadu",
    highlights: "Fully Furnished | Sea View | High Floor | Beach View Villa",
    postedBy: "Anaya Dev",
    postedAs: "Owner",
  ...
  // SELL - Premium Villa (Posted by SELLER)
  {
    ...
    status: "RE-SALE",
    price: "₹1.8 Crores",
    sqftPrice: "₹9,000 per sqft",
    totalSqft: "2,000 sqft Carpet Area",
    builtUp: "2,200 sqft (Built Up area)",
    location: "Ekkaduthangal, Chennai-600032, Tamil Nadu",
    highlights: "Unfurnished | 3 BHK | Gym | Swimming Pool | Spacious Villa",
    postedBy: "Manickam",
    postedAs: "Seller",
    logo: "",
  ...
  // LEASE - Corporate Villa (Posted by LESSOR/OWNER)
  {
    ...
    totalSqft: "1,200 sqft Carpet Area",
    builtUp: "1,350 sqft (Built Up area)",
    location: "Velachery, Chennai-600042, Tamil Nadu",
    highlights: " 2 BHK | Near IT Park | Corporate Villa | 24/7 Security",
    postedBy: "Suresh",
    postedAs: "Lessor",
    logo: "",
  ...
  // BUY - Premium Resale Villa (Posted by REAL ESTATE AGENT)
  {
    id: 5,
    tag: "BUY",
    status: "RE-SALE",
    price: "₹3.2 Crores",
    sqftPrice: "₹12,800 per sqft",
    totalSqft: "2,500 sqft Carpet Area",
    builtUp: "2,700 sqft (Built Up area)",
    location: "Adyar, Chennai-600020, Tamil Nadu",
    highlights: "Semi-Furnished | 4 BHK | Club House | Premium Villa",
  ...
  // RENT - Budget Villa (Posted by OWNER)
  {
    ...
    totalSqft: "720 sqft Carpet Area",
    builtUp: "800 sqft (Built Up area)",
    location: "Anna Nagar, Chennai-600040, Tamil Nadu",
    highlights: "Semi-Furnished | 1 BHK | Close to Metro | Budget Villa",
    postedBy: "Rajesh V",
    postedAs: "Owner",
    logo: "",
  ...
  // SELL - Affordable Villa (Posted by SELLER)
  {
    ...
    totalSqft: "1,000 sqft Carpet Area",
    builtUp: "1,100 sqft (Built Up area)",
    location: "Madipakkam, Chennai-600091, Tamil Nadu",
    highlights: "Semi-Furnished | 2 BHK | Affordable Villa | Vaastu Compliant",
    postedBy: "Deepak",
    postedAs: "Seller",
    logo: "",
  ...
  // LEASE - Compact Villa (Posted by OWNER)
  {
    ...
    totalSqft: "850 sqft Carpet Area",
    builtUp: "950 sqft (Built Up area)",
    location: "Nungambakkam, Chennai-600034, Tamil Nadu",
    highlights: "Semi-Furnished | 2 BHK | Gated Community | Lift Available",
    postedBy: "Redlay",
    postedAs: "Owner",
    logo: "",
  ...
  // BUY - Modern Villa (Posted by BUILDER/DEVELOPER)
  {
    ...
    status: "NEW",
    price: "₹2.5 Crores",
    sqftPrice: "₹10,000 per sqft",
    totalSqft: "2,500 sqft Carpet Area",
    builtUp: "2,700 sqft (Built Up area)",
    location: "OMR, Thoraipakkam, Chennai-600097, Tamil Nadu",
    highlights: "Unfurnished | Open Terrace | Modern Villa | Smart Home Features",
    postedBy: "Siva Kumar",
    postedAs: "Builder",
    logo: "",
  ...
  // RENT - Heritage Style Villa (Posted by AGENT)
  {
    id: 10,
    tag: "RENT",
    status: "RE-SALE",
    price: "₹55,000/month",
    sqftPrice: "₹45 per sqft",
    totalSqft: "1,220 sqft Carpet Area",
    builtUp: "1,350 sqft (Built Up area)",
    location: "Mylapore, Chennai-600004, Tamil Nadu",
    highlights: "Semi-Furnished | 2 BHK | Traditional Style | Heritage Building",
