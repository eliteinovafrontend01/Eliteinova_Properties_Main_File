...
import {DuplexResidentialData } from '../data/DuplexResidentialData';

const PAGE_NAME = "Duplex Residential";
...
const DuplexResidential = () => {
  const [showLoginModal, setShowLoginModal] = useState(false);
  const [selectedProperty, setSelectedProperty] = useState(null);
  const [showContactInfo, setShowContactInfo] = useState(false);
  const [filteredProperties, setFilteredProperties] = useState(DuplexResidentialData);
...
export default DuplexResidential;