...
import WarehouseLandFilter from "../../components/filters/LandAndPlots/WarehouseLandFilter";
import WarehouseLand from "../../components/propertycard/LandAndPlots/WarehouseLand";
...
const WarehouseLandPage = () => {
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search warehouse land by city, industrial area, or project name"
        ...
        <section className="w-full relative flex items-center justify-center group py-2 md:py-4">
          ...
          <div className="max-w-none mx-auto px-4 sm:px-6 relative z-10 text-center w-full flex flex-col items-center justify-center gap-2">
            ...
            <p className="text-sm md:text-base lg:text-lg text-white/90 max-w-3xl mx-auto leading-relaxed px-2">
              Discover prime warehouse land for your logistics and storage business
            </p>
