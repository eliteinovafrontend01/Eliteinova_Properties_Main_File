...
import CommercialPlotFilter from "../../components/filters/LandAndPlots/CommercialPlotFilter";
import CommercialPlot from "../../components/propertycard/LandAndPlots/CommercialPlot";

const CommercialPlotPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("Commercial Plot");
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search commercial plots by city, locality, or project name"
...
export default CommercialPlotPage;