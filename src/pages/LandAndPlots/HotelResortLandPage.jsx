...
import HotelResortLandFilter from "../../components/filters/LandAndPlots/HotelResortLandFilter";
import HotelResortLand from "../../components/propertycard/LandAndPlots/HotelResortLand";

const HotelResortLandPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("Hotel / Resort Land");
  ...
  useEffect(() => {
    ...
    if (activeType) {
      ...
      setActiveLandType("Hotel / Resort Land");
    }
  }, [location.pathname]);
