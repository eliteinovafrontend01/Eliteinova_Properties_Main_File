// FisheriesAquacultureLandPage.jsx
...
const FisheriesAquacultureLandPage = () => {
  ...
  const [activeLandType, setActiveLandType] = useState("Fisheries / Aquaculture Land");
  ...
  useEffect(() => {
    ...
    if (activeType) {
      ...
      setActiveLandType("Fisheries / Aquaculture Land");
    }
  }, [location.pathname]);
...
export default FisheriesAquacultureLandPage;