...
const DuplexResidentialUnitPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Rent");
  const [activeHouseType, setActiveHouseType] = useState("Duplex Residential Unit");
        ...
        <section className="w-full h-[350px] md:h-[450px] relative flex items-center overflow-hidden group">
          ...
          <div className="max-w-none mx-auto px-6 relative z-10 text-center w-full">
            <div className="mb-6 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-teal-600/20 to-emerald-600/20 backdrop-blur-lg border border-teal-300/20 animate-float-glow shadow-[0_0_30px_rgba(0,105,92,0.3)]">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-emerald-300 text-sm font-medium">Premium Duplex Units</span>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 animate-slide-up drop-shadow-[0_0_30px_rgba(0,105,92,0.5)]">
              Find Your Dream <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 via-orange-400 to-amber-300 animate-gradient-text">Duplex Residential Unit</span>
            </h1>
            
            <p className="text-lg md:text-xl lg:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed ">Experience spacious duplex living with modern design, premium amenities, and prime locations</p>
            ...
            <div className="hidden md:block space-y-4">
              <div className="flex gap-4 items-center">
                ...
                <div className="relative flex-1 group">
                  ...
                  <input type="text" placeholder="Search duplex units by city, locality, or landmark" className="w-full pl-12 pr-5 py-3.5 rounded-2xl border-2 border-teal-200/50 bg-teal-50/90 text-base focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/30 shadow-xl text-teal-900 placeholder-teal-400 transition-all duration-500 relative z-10 hover:shadow-2xl" />
            ...
            <div className="lg:w-2/3">
              <section>
                <div className="bg-gradient-to-br from-teal-50/90 via-emerald-50/90 to-teal-50/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 lg:p-12 text-center border border-teal-200/30 hover:shadow-[0_0_60px_rgba(249,115,22,0.3)] transition-all duration-700 group animate-fade-in-up">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-teal-900 mb-4">Duplex Residential Units <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 via-orange-500 to-amber-600 animate-gradient-text-slow">Coming Soon</span></h2>
                  <p className="text-teal-800 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed backdrop-blur-sm bg-teal-100/30 rounded-2xl p-6 border border-teal-200/20">Premium duplex units with elegant designs, spacious layouts, and modern amenities coming soon to prime locations.<span className="block mt-4 text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-orange-500 font-semibold text-xl">Check back soon for amazing deals!</span></p>
...
export default DuplexResidentialUnitPage;