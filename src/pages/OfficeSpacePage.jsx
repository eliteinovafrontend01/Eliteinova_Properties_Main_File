        ...
        <div className="max-w-none mx-auto px-6 py-6 lg:py-10">
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
            ...
            <div className="lg:w-2/3">
              ...
              {/* Stats Banner */}
              <div className="mt-6 bg-gradient-to-r from-teal-50/80 to-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-teal-200/30">
                <div className="flex flex-wrap justify-around gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-2xl font-bold text-teal-800">10-200</p>
                  </div>
                  <div className="text-center">
                    <div className="flex items-center gap-1 text-teal-600 justify-center">
                      <Wifi className="w-4 h-4" />
                      <span className="text-sm font-semibold">High-Speed Internet</span>
                    </div>
                    <p className="text-2xl font-bold text-teal-800">Included</p>
                  </div>
                </div>
              </div>
            </div>
