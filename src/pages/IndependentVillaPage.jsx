        ...
        <section className="w-full h-[350px] md:h-[450px] relative flex items-center overflow-hidden group">
          ...
          <div className="max-w-none mx-auto px-6 relative z-10 text-center w-full">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 animate-slide-up drop-shadow-[0_0_30px_rgba(0,105,92,0.5)]">
              Find Your Dream <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 via-orange-400 to-amber-300 animate-gradient-text">Independent Villa</span>
            </h1>
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="relative z-10 flex items-center gap-3">
                        ...
                        {type.name}
                        {isActive && <span className="absolute -top-1 -right-1 w-2 h-2 bg-orange-400 rounded-full animate-pulse"></span>}
                      </span>
                    </button>
                  );
                })}
