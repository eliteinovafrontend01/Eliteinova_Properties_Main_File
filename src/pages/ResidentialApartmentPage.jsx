...
const ResidentialApartmentPage = () => {
  ...
  const [activeHouseType, setActiveHouseType] = useState("Residential Apartment");
        ...
        <section className="w-full h-[350px] md:h-[450px] relative flex items-center overflow-hidden group">
          ...
          <div className="max-w-none mx-auto px-6 relative z-10 text-center w-full">
            <div className="mb-6 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-teal-600/20 to-emerald-600/20 backdrop-blur-lg border border-teal-300/20 animate-float-glow shadow-[0_0_30px_rgba(0,105,92,0.3)]">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-emerald-300 text-sm font-medium">Premium Apartments</span>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 animate-slide-up drop-shadow-[0_0_30px_rgba(0,105,92,0.5)]">
              Find Your Perfect <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 via-orange-400 to-amber-300 animate-gradient-text">Residential Apartment</span>
            </h1>
            
            <p className="text-lg md:text-xl lg:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed ">Discover modern residential apartments with premium amenities and strategic locations</p>
